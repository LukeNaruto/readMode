! function (e, t) {
  ...
  var re = Object.freeze({
      ...
      commbeautify: function (e, t) {
        // console.log('---e,t---------',e,t,t.find("video"))
        t.find("video").map(function (e, t) {
          var r = $(t),
            a = r.parent();
            // console.log('---e,t--video-------',e,t,a)
          if(!a.hasClass('sr-rd-content-center')) r.wrap("<div class='sr-rd-content-center'></div>");
        ...
        t.find("img:not(.sr-rd-content-nobeautify)").map(function (e, t) {
          ...
          a.attr("src", f).replaceAll(r).wrap("<div class='sr-rd-content-center'></div>"), 
          /win|mac/i.test(navigator.platform) ? a.one("load", function () {
            return d()
          }).one("error", function () {
            return h()
          }) : a.on("load", function () {
          ...
          $(t).wrap("<div class='sr-rd-content-center b'></div>")
      ...
      cleanHTML: function (e, t, r) {
        ...
        "readability-page-1" == $(e.children()).attr("id") && 1 == e.children().children().length ? i = e.children().children().html() : 1 == e.children().length && (i = e.children().html()), 
        // i = i.replace(/<!--[\S]+-->/gi, ""), 
        i = i.replace(/<!--.*?-->/g, ''),
        e.html((a = i, n = "", $.parseHTML(a).forEach(function (e, a) {
          var i = e.tagName,
            o = e.outerText,
            s = e.outerHTML;
          void 0 == i ? n += "<p>" + e.textContent.replace(/</gi, "&lt;").replace(/>/gi, "&gt;").replace(/^\n|\n$/gi, "").trim() + "</p>" : "PRE" == i ? n += s : "sr-blocks" == i.toLowerCase() ? n += s : ("" != o || s.includes("<img") || s.includes("<video")) && (n += t && 0 == r ? s.replace(/ (style|id|class)="[\w ;%@#!-:(),\u4e00-\u9fa5]*"/gi, "") : s)
        }), n)), 
        t && e.find("p").each(function (e, t) {
          t.tagName;
          var r = t.outerText,
            a = t.outerHTML;
    ...
    he = r(function (e) {
      (function () {
        ...
        i.subParser("autoLinks", function (e, t, r) {
          ...
          var a = ["pre", "div", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "table", "dl", "ol", "ul", "script", "noscript", "form", "fieldset", "iframe", "math", "style", "section", "header", "footer", "nav", "article", "aside", "address", "audio", "canvas", "figure", "hgroup", "output",  "p"],
            n = function (e, t, a, n) {
              var i = e;
