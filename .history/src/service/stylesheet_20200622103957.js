...
function fontSize( value ) {
    ...
    value ? $( "html" ).attr( "style", `--fsize: ${value - 18}px!important;${html_style_bal}` ) : $( "html" ).attr( "style", html_style_bal );
}
...
async function customFontFamily(fonts){
    fonts.forEach(font => {
        ...
        // $('.simpread-read-root').append(`<span class="font-preload" style="font-family: ${family}">1</span>`)
    });
}
