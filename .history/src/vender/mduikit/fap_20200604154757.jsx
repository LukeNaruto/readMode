...
class Panel extends React.Component {
    ...
    render() {
        ...
        console.log(987,this.props.children);
...
export default class Fap extends React.Component {
    ...
    render() {
        ...
        const tools = btn_group.map(item => {
            var imgURL = chrome.extension.getURL(`assets/images/icons/${item.icon}.png`);
            return (
                <a href="" style={{backgroundImage: imgURL}}>{item.title}</a>
            )
        })
        return (
            <fap { ...evt } >
