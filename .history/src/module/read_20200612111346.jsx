        ...
        return (
            <sr-opt-read>
                ...
                <sr-opt-gp>
                    ...
                    <Slider min="720" max="1200" step="1" icontexts={[700, 1200]} width={slider_width} value={ this.parse( this.props.option.layout == "" ? "1000" : this.props.option.layout ) } onChange={ (v)=>this.changeLayout(v) }/>
                </sr-opt-gp>
                <sr-opt-gp>
