...
export default class ReadOpt extends React.Component {
    ...
    changeFontsize( value ) {
        this.props.option.fontsize = (value - 18) + "px";
        ...
        return (
            <sr-opt-read>
                ...
                <sr-opt-gp>
                    ...
                    <Slider min="12" max="30" step="2" width={slider_width} value={ this.parse( this.props.option.fontsize == "" ? "18" : this.props.option.fontsize ) } onChange={ (v)=>this.changeFontsize(v) }/>
                </sr-opt-gp>
                <sr-opt-gp>
                ...
                <sr-opt-gp>
                    ...
                    <Slider min="720" max="1200" step="1" width={slider_width} value={ 100 - this.parse( this.props.option.layout == "" ? "1000" : this.props.option.layout ) } onChange={ (v)=>this.changeLayout(v) }/>
                </sr-opt-gp>
                <sr-opt-gp>
