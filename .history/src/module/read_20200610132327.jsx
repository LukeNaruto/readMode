        ...
        return (
            <sr-opt-read>
                ...
                <sr-opt-gp>
                    ...
                    <Slider min="720" max="1200" step="1" width={slider_width} value={ 100 - this.parse( this.props.option.layout == "" ? "20%" : this.props.option.layout ) } onChange={ (v)=>this.changeLayout(v) }/>
                </sr-opt-gp>
                <sr-opt-gp>
