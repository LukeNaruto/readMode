    ...
    render() {
        return (
            <sr-opt-themes onClick={ evt=> this.changeBgColor(evt) }>
                { this.props.themes.map( (theme,idx) => <sr-opt-theme class="iconfont icon-set-typeface-20px" style={{backgroundColor: `rgba( ${theme} )`}} name={ this.props.names[idx] }></sr-opt-theme> )}
