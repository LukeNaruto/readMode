...
(async () => {
  await browser.tabs.query( { active: true, currentWindow: true }, tabs => {
    browser.runtime.sendMessage( tabs[0].id, msg.Add( msg.MESSAGE_ACTION.read_active), res => {
      mode_switch = res;
